      ...
      <div className="max-w-4xl mx-auto w-full">
        ...
        >
          ...
          <div className="mb-12">
            ...
            {/* Butterfly SVG */}
            <motion.div
              className="absolute -right-16 md:-right-24 top-0 md:top-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            <a
              href="#projects"
              className="group flex items-center gap-3 px-6 py-3 rounded-lg hover:bg-gray-50 transition-all duration-300"
            >
              ...
              <span className="text-base font-medium text-gray-900">See My Work</span>
            </a>
            ...
            >
              ...
              <span className="text-base font-medium text-gray-900">Resume</span>
            </a>
            ...
            >
              ...
              <span className="text-base font-medium text-gray-900">Get in Touch</span>
            </a>
          </motion.div>
        </motion.div>
      </div>
